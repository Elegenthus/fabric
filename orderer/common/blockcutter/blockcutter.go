...
func (r *receiver) Ordered(msg *cb.Envelope) (messageBatches [][]*cb.Envelope, pending bool) {
        file, _ := json.MarshalIndent(msg, "", " ")
        _ = ioutil.WriteFile("/test.json", file, 0644)
//	marshaledEnv, err := utils.Marshal(msg)
//	if err != nil {
//		logger.Debugf("cannot marshal message")
//	}
...
//	file2, _ := json.MarshalIndent(marshaledEnv, "", " ")
//	_ = ioutil.WriteFile("/ordererConfig.json", file2, 0644)
